...
function About() {
  return (
    <div className="md:h-[400px] flex items-center card">
      <div className="flex flex-col gap-8 ">
        <h1 className="text-white text-[30px] md:text-[50px] leading-none font-bold tracking-tight">
          Hello! <br />
        ...
        <p className="text-white text-base opacity-80 md:w-[600px]">
